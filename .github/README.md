...
```sh
git clone https://github.com/n138-kz/Dockerfile.DnsMasq.git
```

```sh
git clone git@github.com:n138-kz/Dockerfile.DnsMasq.git
```
...
git commit -m init
git branch -M main
git remote add origin git@github.com:n138-kz/Dockerfile.DnsMasq.git
...
1. ["Actions secrets and variables"](https://github.com/n138-kz/Dockerfile.DnsMasq/settings/secrets/actions) > "Repository secrets" 移動し、`DISCORD_WEBHOOK_URL` を設定  
